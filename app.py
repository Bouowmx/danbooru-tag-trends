...
@app.route("/")
def top_100():
    tags = database_connection()["danbooru_tags"]["tags"].find(limit = 100)
    tags.sort("post_count", pymongo.DESCENDING)
    ...
    return flask.render_template("home.html", tags = tags, total_posts = total_posts)
